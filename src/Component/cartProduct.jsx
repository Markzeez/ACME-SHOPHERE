...
<h3 className="font-semibold text-slate-600 text-center capitalize text-lg md:text-xl  ">
          ...
          <button onClick={()=>dispatch(increaseQty(id))} className='bg-slate-300 py-1 mt-2 rounded hover:bg-slate-400 p-1 '><GoPlus /></button>
          <p className='font-semibold p-1 '>{qty}</p>
          <button onClick={()=>dispatch(decreaseQty(id))}  className='bg-slate-300 py-1 mt-2 rounded hover:bg-slate-400 p-1 '><HiOutlineMinusSmall /></button>
          </div>
